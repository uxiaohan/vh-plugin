  ...
  return {
    ...
    imgLightBoxInit: vhDomArr => {
      ...
      (function () {
        ...
        function Na(a) {
          var b = db.call(a.target, ".vh-lightbox");
          if (b) {
            var c = db.call(b, ".vh-lightbox-group"),
              d = m("vh-lightbox", c);
        ...
        function Qa() {
          N && "#vh-lightbox" === location.hash && ab(!0);
        }
        function Xa(a) {
